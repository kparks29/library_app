...
class ReadersControllerTest < ActionController::TestCase
  ...
  test "should create reader" do
    assert_difference('Reader.count') do
      post :create, reader: { email: @reader.email, membership_id: @reader.membership_id, name: @reader.name, phone: @reader.phone }
    end
  ...
  test "should update reader" do
    patch :update, id: @reader, reader: { email: @reader.email, membership_id: @reader.membership_id, name: @reader.name, phone: @reader.phone }
    assert_redirected_to reader_path(assigns(:reader))
  end
